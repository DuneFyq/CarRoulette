...
class CreateRoomDialog(Box):
    ...
    def create_content(self, container):
        ...
        self.access_option = ctk.CTkOptionMenu(container, values=["public", "private"], width=140)
        self.access_option.set("public")
        self.access_option.grid(row=1, column=1, padx=12, pady=10, sticky="w")
        self.access_option.bind("<<ComboboxSelected>>", lambda e=None: self._toggle_password())
